...
var employees = [
  get_employee(["../assets/img-1.jpg","Antony ","Morris","SharePoint Practice Head","Antony","IT Department",9876543210,"abc@gmail.com",3421783,"Seattle"]),
  get_employee(["../assets/img-2.jpg","Helen ","Zipperman","Operations Manager","Helen","IT Department",9876543210,"abc@gmail.com",3421783,"Seattle"]),
  get_employee(["../assets/img-3.jpg","Jonathan ","Smith","Product Manager","Jonathan","IT Department",9876543210,"abc@gmail.com",3421783,"India"]),
  get_employee(["../assets/img-4.jpg","Angela ","Bailey","Talent Manager Jr.","Angela","HR Department",9876543210,"abc@gmail.com",3421783,"India"]),
  get_employee(["../assets/img-5.jpg","Tami ","Hopkins","Lead Engineer Dot Net","Tami","IT Department",9876543210,"abc@gmail.com",3421783,"India"]),
  get_employee(["../assets/img-6.jpg","Franklin ","Humark","Network Engineer","Franklin","IT Department",9876543210,"abc@gmail.com",3421783,"India"]),
  get_employee(["../assets/img-7.jpg","Olivia ","Watson","UI Designer","Olivia","UX Department",9876543210,"abc@gmail.com",3421783,"India"]),
  get_employee(["../assets/img-8.jpg","Robert ","Mitchell","Software Engineer","Robert","IT Department",9876543210,"abc@gmail.com",3421783,"India"])
];
...
var jobs = [
  get_job(["SharePoint Practice Head",1]),
  get_job(["Operations Manager",1]),
  get_job(["Product Manager",1]),
  get_job(["Talent Manager Jr.",1]),
  get_job(["Lead Engineer Dot Net",1]),
  get_job(["Network Engineer",1]),
  get_job(["UI Designer",1]),
  get_job(["Software Engineer",1])
];
...
add.addEventListener("click", () => {
  if (
    ...
    let new_employee=get_employee(["../assets/img-5.jpg",input[1].value+" ",input[2].value,input[4].value,input[1].value,input[6].value,input[7].value,input[8].value,input[3].value,input[5].value]);
